...
urlpatterns = [    
    ...
    path('quiz-admin', views.admin_dashboard, name='admin-dashboard'),
...
urlpatterns += [
    ...
    path('api/quiz/remove-question/<uuid:pk>', api.RemoveQuestionAPIView.as_view(), name='api-question-remove'),
    ...
    path('api/quiz/unassign-quiz/<uuid:pk>', api.UnAssignQuizAPIView.as_view(), name='api-quiz-unassign'),
